    ...
    Modal.open({
      ...
      content: `
        <div style="padding: 40px; text-align: center;">
            ...
            <p style="margin-top: 15px; color: #64748b;">Cargando opciones de difusión...</p>
        </div>
      `,
  ...
  function bindEvents(campaigns) {
    ...
    if (btnDownload) {
      btnDownload.on("click", function () {
        ...
        setTimeout(() => {
          alert(`¡Descarga iniciada! Se empaquetaron ${camp.archivos.length} archivo(s) de la campaña "${camp.nombre}".`, "Ok");
